...
# background
background = pygame.image.load(os.path.join(image_path, "C:\programming\pygame\pygame_project\images\\background.png"))
...
# character
character = pygame.image.load(os.path.join(image_path, "C:\programming\pygame\pygame_project\images\character.png"))
...
# 20 fps : 1초동안 20번 동작 -> 1번에 몇만큼 이동해야 하나? ==> 20*5 = 100
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            continue # 안쪽 for 문 조건 안 맞으면 continue
        break # 안쪽 for 문 끝나면 여기로 진입 가능
